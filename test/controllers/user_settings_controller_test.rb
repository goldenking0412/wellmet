...
class UserSettingsControllerTest < ActionController::TestCase
  ...
  test "should create user_setting" do
    assert_difference('UserSetting.count') do
      post :create, user_setting: { ages: @user_setting.ages, common_interests_count: @user_setting.common_interests_count, gender: @user_setting.gender, radius: @user_setting.radius, user_id: @user_setting.user_id }
    end
  ...
  test "should update user_setting" do
    patch :update, id: @user_setting, user_setting: { ages: @user_setting.ages, common_interests_count: @user_setting.common_interests_count, gender: @user_setting.gender, radius: @user_setting.radius, user_id: @user_setting.user_id }
    assert_redirected_to user_setting_path(assigns(:user_setting))
  end
