...
class ErrorsControllerTest < ActionController::TestCase
  ...
  test "should create error" do
    assert_difference('Error.count') do
      post :create, error: { internal_server_error: @error.internal_server_error, not_found: @error.not_found }
    end
  ...
  test "should update error" do
    patch :update, id: @error, error: { internal_server_error: @error.internal_server_error, not_found: @error.not_found }
    assert_redirected_to error_path(assigns(:error))
  end
