  ...
  .directive('datetimepicker', [
    function () {
      ...
      return {
        ...
        template: function (elem, attrs) {
          ...
          var dateTmpl = "<div class=\"datetimepicker-wrapper\">" +
            "<input class=\"form-control input-text date-icon margin-fix\" type=\"text\" " +
            "name=\"datepicker\"" +
            "type=\"{{vm.user.date_of_birth ? 'date' : 'text'}}\" "+
      "ng-model=\"vm.user.date_of_birth\" "+
      "id=\"datevalue\" " +
      "ng-class=\"{ 'placeholder': !vm.user.date_of_birth}\" "+
      "placeholder=\"Date of Birth\" "+
            ...
            "/>\n" +
      "<span for=\"birthMonth\" class=\"floating-label\">Date of Birth"+ "</span>" +
            "</div>\n";
